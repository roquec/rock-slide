...
public class RubyBehaviour : MonoBehaviour {
	...
	void Start () {
		GetComponentInChildren<ParticleSystem> ().GetComponent<Renderer>().sortingLayerName = "Ruby";
		GetComponentInChildren<ParticleSystem> ().GetComponent<Renderer>().sortingOrder = 0;
